        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <a href="agregar_producto.php" class="btn btn-primary btn-xs">Agregar producto</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align:middle;">
                                <div class="btn-group">
                                    <a href="editar_producto.php?id=<?php echo (int)$producto['id'];?>" class="btn btn-info btn-xs"  title="Editar" data-toggle="tooltip">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="eliminar_producto.php?id=<?php echo (int)$producto['id'];?>" class="btn btn-danger btn-xs"  title="Eliminar" data-toggle="tooltip">
